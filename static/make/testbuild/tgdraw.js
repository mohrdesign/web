...
lib.ssMetadata = [
		{name:"tgdraw_atlas_", frames: [[0,1320,2048,150],[1320,1190,529,107],[1316,1754,338,126],[1718,1472,271,30],[1600,1574,204,45],[1316,1472,282,280],[1028,1472,286,286],[1924,1132,48,54],[0,0,1318,1318],[1190,1760,116,100],[1924,1026,120,104],[1190,1862,116,100],[1600,1472,116,100],[1851,1190,191,122],[1320,1026,602,162],[0,1472,512,512],[514,1472,512,512],[1320,0,683,1024],[1028,1760,160,200]]}
];
...
(lib.saveicon = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(2,1,0.042,0.042);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.saveicon, new cjs.Rectangle(2,1,21.5,21.5), null);
...
(lib.loader = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(477.2,533.1,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(0,0,1024,1100);
...
(lib.buyicon = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.Bitmap15();
	this.instance.setTransform(97,89,0.6412,0.6412);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.buyicon, new cjs.Rectangle(97,89,328.3,328.3), null);
...
}).prototype = getMCSymbolPrototype(lib.btncolorsquare, new cjs.Rectangle(0,0,95.5,61), null);
...
}).prototype = getMCSymbolPrototype(lib.gridm, new cjs.Rectangle(-0.7,-0.6,1028.8,1028.6999999999998), null);
...
(lib.downloadbutton = function(mode,startPosition,loop) {
	...
	this.instance.cache(0,-1,26,26);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:12.4,regY:12.4,x:28.4,y:25.4},0).wait(1).to({y:27.4},0).wait(2));
...
(lib.buybutton = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_2
	this.instance = new lib.buyicon();
	this.instance.setTransform(8,5,0.0781,0.0781);
	this.instance.filters = [new cjs.ColorFilter(0, 0, 0, 1, 255, 255, 255, 0)];
	this.instance.cache(95,87,332,332);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:256,regY:256,x:28,y:23},0).wait(1).to({y:25},0).wait(2));
...
(lib.utils = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.btnprint = new lib.buybutton();
	this.btnprint.name = "btnprint";
	this.btnprint.setTransform(868.3,12);
	new cjs.ButtonHelper(this.btnprint, 0, 1, 2, false, new lib.buybutton(), 3);
	...
	this.btnclear.setTransform(627.6,12);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btnsave},{t:this.btnclear},{t:this.logo},{t:this.btnprint}]}).wait(1));

	// Layer_3
	this.btncolor1 = new lib.btncolorsquare();
	this.btncolor1.name = "btncolor1";
	this.btncolor1.setTransform(471.75,37.15,0.845,0.845,0,0,0,48,30.4);

	this.btncolor2 = new lib.btncolorsquare();
	this.btncolor2.name = "btncolor2";
	this.btncolor2.setTransform(562.35,37.15,0.845,0.845,0,0,0,47.9,30.4);

	this.btncolor0 = new lib.btncolorsquare();
	this.btncolor0.name = "btncolor0";
	this.btncolor0.setTransform(380.9,37.15,0.845,0.845,0,0,0,47.8,30.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btncolor0},{t:this.btncolor2},{t:this.btncolor1}]}).wait(1));

	// Layer_4
	this.instance = new lib.CachedBmp_18();
	this.instance.setTransform(339.5,10.45,0.5,0.5);
...
(lib.TGramDraw_3COL_html = function(mode,startPosition,loop) {
	...
	this.frame_1 = function() {
		...
		function Main() {
			...
			this.utils.btnprint.addEventListener("click",this.buyprint.bind(this));
			...
			var pstate = getParam("state");
			if(pstate)state = pstate;
			var versioncheck = getCookie("version");
			if(versioncheck != this.version){
				setCookie("version",this.version,356);
				state=null;
				pstate=null;
		...
		Main.prototype.setstate = function(state,instant=true){
			//alert("setstate");
			console.trace(state);
			...
			this.refreshgrid(false,instant);
		}
		...
		var loadmc
		var zazz = true;
		Main.prototype.buyprint = function(e){
			if(!zazz)return;
			zazz=false;
			ga('send','event','MakeMohr','buyprint');
			//window.open('http://mohr.design', '_blank');
			this.grid.scale=2;
			
			exportRoot.container.cache(0,0,2048,2048);
			dataURL = exportRoot.container.bitmapCache.getCacheDataURL();
			exportRoot.container.uncache();
			this.grid.scale=1;
			loadmc = new lib.loader();
			exportRoot.container.addChild(loadmc);
			mmdfn = "mmd"+Date.now();
			console.trace('saving file : ' + mmdfn); 
			//exportRoot.container.visible = false;
		...
		Main.prototype.jumptozazzle = function(o) {
			zazz=true;
			loadmc.parent.removeChild(loadmc);
			loadmc = null;
			gsap.to(exportRoot.utils,{duration:.5, y:1025});
		  console.trace('jumping to store: ' + mmdfn); 
				//var jumpurl="https://www.zazzle.com/api/create/at-238114933749521123?rf=238114933749521123&ax=Linkover&pd=235102205179448321&ed=true&tc=&ic=&t_image1_iid=" + "http%3A%2F%2Fscienceninja.com%2Ftgdraw%2Fcomps%2F"+ mmdfn + ".png"
			var jumpurl="https://www.zazzle.com/api/create/at-238114933749521123?rf=238114933749521123&ax=DesignBlast&sr=250738386939430960&cg=0&t__useQpc=true&ed=true&t__smart=false&continueUrl=https%3A%2F%2Fwww.zazzle.com%2Fstore%2Fmakemohr&tc=&ic=&t_image1_iid=" + "http%3A%2F%2Fscienceninja.com%2Ftgdraw%2Fcomps%2F"+ mmdfn + ".png"
		...
		Main.prototype.dosave = function(e){
			...
			//alert("btnsave");
			//this.grid.cache();
			//exportRoot.container.width=2048;
			//exportRoot.container.height=2048;
			this.grid.scale=4;
			exportRoot.container.cache(0,0,4096,4096);
		...
		window.onpopstate = function(event) {
		  //alert("location: " + document.location + ", state: " + JSON.stringify(event.state));
			var pstate = getParam("state",document.location);
			if(pstate){
				console.trace(pstate);
				main.setstate(pstate);
			}
		...
		Main.prototype.domouse= function(e){
			...
			switch(e.type){
				...
				case "pressup":
					...
					window.history.replaceState("", "", '?state='+currentstate);
		...
		Main.prototype.refreshgrid = function(clear=false,instant=false){
			...
			for(i=0; i<this.grid.numChildren;i++){
				...
				if(clear){
					...
					gsap.to(tobj,{duration: temptime, delay:(j*delayint), y:tobj.iy-this.dyint*tobj.boxframe,x:tobj.ix-this.dxint*tobj.boxframe, easel:{tint:this.color0, tintAmount:this.tintamount}});
				}else{
					gsap.to(tobj,{duration: temptime, delay:(i*delayint), y:tobj.iy-this.dyint*tobj.boxframe,x:tobj.ix-this.dxint*tobj.boxframe, easel:{tint:this["color"+tobj.boxframe], tintAmount:this.tintamount}});
				};
	...
	this.instance.setTransform(512,550,1,1,0,0,0,512,550);
	...
	this.blockcount._off = true;

	this.timeline.addTween(cjs.Tween.get(this.blockcount).wait(1).to({_off:false},0).wait(2));

	// Layer_1
	this.utils = new lib.utils();
	this.utils.name = "utils";
	this.utils.setTransform(0,1025);

	this.container = new lib.container();
	this.container.name = "container";

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.container},{t:this.utils}]},1).wait(2));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_15.png?1591299674548", id:"CachedBmp_15"},
		{src:"images/Bitmap1.png?1591299674548", id:"Bitmap1"},
		{src:"images/tgdraw_atlas_.png?1591299674391", id:"tgdraw_atlas_"}
	],
	preloads: []
};
